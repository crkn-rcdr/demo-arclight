...
class CatalogController < ApplicationController
  ...
  configure_blacklight do |config|
    ...
    config.add_sort_field 'score desc, normalized_title_ssm asc', label: 'relevance'
    config.add_sort_field 'normalized_date_ssm asc', label: 'date (ascending)'
    config.add_sort_field 'normalized_date_ssm desc', label: 'date (descending)'
    config.add_sort_field 'creator_sort asc', label: 'creator (A-Z)'
    config.add_sort_field 'creator_sort desc', label: 'creator (Z-A)'
    config.add_sort_field 'normalized_title_ssm asc', label: 'title (A-Z)'
    config.add_sort_field 'normalized_title_ssm desc', label: 'title (Z-A)'
